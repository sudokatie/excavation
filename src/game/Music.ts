/**
 * Music system for Excavation using Web Audio API.
...
class MusicSystem {
  ...
  private playNote(freq: number, startTime: number, duration: number, vol: number = 1): void {
    ...
    // Square wave for classic digging game feel
    osc.type = 'square';
  ...
  // Gameplay track - underground, rhythmic digging feel
  private getGameplayNotes(): Note[] {
    ...
    // Underground mining melody (8 bars)
    const melody = [
      // Bar 1-2: Digging rhythm
      { note: 'C3', dur: eighth },
